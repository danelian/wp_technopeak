<a href="<?php the_permalink(); ?>" class="ncard">
  <h3 class="ncard__title"><?php the_title(); ?></h3>
  <?php the_excerpt(); ?>
  <div class="ncard__date"><?php the_time('d.m.Y') ?></div>
  ...
  <img src="<?php the_post_thumbnail_url('large'); ?>" class="ncard__image" alt="<?php the_title(); ?>">
</a>