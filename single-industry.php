  ...
  <div class="container">
    <div class="si-head">
      <div class="si-head__heading">
        <h1 class="section-title">FINANCE & BANKING</h1>
      ...
      <img src="<?php echo get_template_directory_uri(); ?>/assets/img/si-head-image.jpg" class="si-head__image" alt="">
    </div>
    <div class="si-about">
      <h2 class="section-title">About</h2>
      <div class="si-about__container">
        <div class="si-about__content">
...
<section class="services__group">
  <div class="container">
    <div class="heading">
      <h2 class="section-title">IT SUPPORT & MANAGED SERVICES</h2>
      <p>Variety of IT service support systems that businesses in Dubai and Abu Dhabi need</p>
    </div>
    <div class="services__cards">
      <a href="single-services.html" class="scard">
        <h2 class="scard__title">IT Infrastructure Support</h2>
        <ul>
        ...
        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/services/it-infrastructure-support.png" class="scard__image" alt="">
      </a>
      <a href="single-services.html" class="scard">
        <h2 class="scard__title">IT Infrastructure Support</h2>
        <ul>
          <li>Network support</li>
          <li>Cyber Security support</li>
          <li>Physical Server maintenance Physical Server maintenance Physical Server maintenance</li>
          <li>Monitoring 24/7</li>
          <li>Server Configuration</li>
          <li>Data management</li>
        </ul>
