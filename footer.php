  ...
  <div class="container">
    <div class="footer__wrapper">
      ...
      <div class="footer__bottom">
        ...
        if( $privacy_link ): 
            $privacy_link_url = $privacy_link['url'];
            $privacy_link_title = $privacy_link['title'];
            $privacy_link_target = $privacy_link['target'] ? $privacy_link['target'] : '_self';
            ?>
            <a href="<?php echo esc_url( $privacy_link_url ); ?>" target="<?php echo esc_attr( $privacy_link_target ); ?>"><?php echo esc_html( $privacy_link_title ); ?></a>
        <?php endif; ?>
        <?php if (get_field('copyright', 'options')) : ?><p class="footer__copy"><?php the_field('copyright', 'options'); ?></p><?php endif; ?>
      </div>
    </div>
  </div>
</footer>
