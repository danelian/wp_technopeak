  ...
  <div class="container">
    ...
    <div class="contacts__container">
      <div class="contacts__content">
        <div class="contacts__list">
          <div class="contacts-item">
            <h3 class="contacts-item__title">Telephone:</h3>
            <?php
            if( have_rows('phones', 'options') ):
              while( have_rows('phones', 'options') ) : the_row();
              $phones_phone = get_sub_field('item', 'options');
              if( $phones_phone ): 
                  $phones_phone_url = $phones_phone['url'];
                  $phones_phone_title = $phones_phone['title'];
                  $phones_phone_target = $phones_phone['target'] ? $phones_phone['target'] : '_self';
                  ?>
                  <a href="<?php echo esc_url( $phones_phone_url ); ?>" target="<?php echo esc_attr( $phones_phone_target ); ?>"><?php echo esc_html( $phones_phone_title ); ?></a>
              <?php endif;
              endwhile;
              endif;
            ?>
          ...
          <div class="contacts-item">
            <h3 class="contacts-item__title">Address:</h3>
            <?php if (get_field('address', 'options')) : ?><p><?php the_field('address', 'options'); ?></p><?php endif; ?>
          </div>
          <div class="contacts-item">
            ...
            if( $email_link ): 
              ...
              ?>
              <a href="<?php echo esc_url( $email_link_url ); ?>" target="<?php echo esc_attr( $email_link_target ); ?>"><?php echo esc_html( $email_link_title ); ?></a>
            <?php endif; ?>
          </div>
          <div class="contacts-item">
            <h3 class="footer__title">Social networks:</h3>
            <?php if(get_field('telegram_link', 'options')): ?>
              <a class="social" href="<?php the_field('telegram_link', 'options'); ?>" target="_blank">
            ...
            <?php if(get_field('whatsapp_link', 'options')): ?>
              <a class="social" href="<?php the_field('whatsapp_link', 'options'); ?>" target="_blank">
                <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <?php if(get_field('instagram_link', 'options')): ?>
              <a class="social" href="<?php the_field('instagram_link', 'options'); ?>" target="_blank">
                <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div class="contacts__map">
        <img src="<?php the_field('contacts_map'); ?>" alt="map">
      </div>
    </div>
    <div class="contacts__digits">
      <div class="left">
        <div class="over"></div>
        <?php if (get_field('text_over')) : ?><div class="over"><?php the_field('text_over'); ?></div><?php endif; ?>
        <div class="group">
          <?php if (get_field('text_150000')) : ?><div class="numb"><?php the_field('text_150000'); ?></div><?php endif; ?>
          <?php if (get_field('text_projects')) : ?><div class="text"><?php the_field('text_projects'); ?></div><?php endif; ?>
        </div>
      </div>
      <div class="right">
        <div class="group">
          <?php if (get_field('text_professionals')) : ?><div class="text"><?php the_field('text_professionals'); ?></div><?php endif; ?>
          <?php if (get_field('text_500')) : ?><div class="numb"><?php the_field('text_500'); ?></div><?php endif; ?>
        </div>
        <div class="group">
          <?php if (get_field('text_officesin')) : ?><div class="text"><?php the_field('text_officesin'); ?></div><?php endif; ?>
          <?php if (get_field('text_7countres')) : ?><div class="numb"><?php the_field('text_7countres'); ?></div><?php endif; ?>
        </div>
      </div>
    </div>
  </div>
